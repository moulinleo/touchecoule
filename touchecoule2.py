...
def tir_IA(tableau_joueur, tirs_precedents):      #ex tirs_precedent: [[1,-1,[2,5]],[2,0,[3,6]]] [orientaton(-1 si aléatoire)[x,y]]  
...
def demande_orientation(orientation,tableau_joueur,navire, x, y):
	...
	if orientation == 0:
		...
		print("Impossible de mettre le bateau à cet endroi.")
		bonne_orientation=False
	else :
